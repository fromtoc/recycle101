layui.define(['element'], function (exports) {
    ...
    RIGHTMENUMOD.prototype.render = function (opt) {
        if (!opt.container) {
            console.error("[ERROR]To use the rightmenu component you need to specify the 'container' property！");
            return;
        }
        if (!opt.filter) {
            console.error("[ERROR]Use the rightmenu component to specify the 'filter' property！");
            return;
        }
        ...
        var defaultNavArr = [
            {eventName: 'refresh', title: 'Refresh current page'},
            {eventName: 'closeallbutpin', title: 'Turn off all but fixed'},
            {eventName: 'closethis', title: 'Close Tab'},
            {eventName: 'closeothersbutpin', title: 'Close other but fixed'},
            {eventName: 'closeleftbutpin', title: 'Close the left TAB but fix'},
            {eventName: 'closerightbutpin', title: 'Close the right TAB but fix'}
        ];
        opt = opt || {};
