...
layui.define(['element', 'common'], function(exports) {
	...
	Navbar.prototype.render = function() {
		...
		if(typeof(_config.elem) !== 'string' && typeof(_config.elem) !== 'object') {
			common.throwError('Navbar error: elem parameters not defined or set error, please refer to the documentation API.');
		}
		var $container;
		...
		if($container.length === 0) {
			common.throwError('Navbar error:The elem parameter configured container cannot be found. Please check.');
		}
		if(_config.data === undefined && _config.url === undefined) {
			common.throwError('Navbar error:Configure the data source for Navbar.')
		}
...
//		$('.layui-nav-tree .layui-this').removeClass('layui-this');
		...
		if(typeof(events) !== 'string') {
			common.throwError('Navbar error:Event name configuration error, please refer to API documentation.');
		}
