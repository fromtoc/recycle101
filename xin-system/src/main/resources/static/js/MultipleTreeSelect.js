...
(function ($) {
    ...
    var init_tree_container = function () {
        ...
        this.tree_container = $('<div   class="menuContent" style="position: absolute;left: 0px;top: 42px;padding: 5px 0px 10px;z-index: 9999;min-width: 100%;border: 1px solid rgb(210, 210, 210);max-height: 300px;background-color: rgb(255, 255, 255);border-radius: 2px;box-shadow: rgba(0, 0, 0, 0.12) 0px 2px 4px;box-sizing: border-box;display: none;overflow-y: auto;" >' +
