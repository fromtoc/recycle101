...
public class RestApiUtils {
    ...
    private enum Operation {
        ...
        SERVERINFO(getApiUriBuilder().path("serverinfo"));
    ...
    private static UriBuilder getApiUriBuilder() {
        return UriBuilder.fromPath(m_properties.getProperty("server.host") + "/api/3.3");
    }
    /**
    ...
    private Logger m_logger = LoggerFactory.getLogger(RestApiUtils.class);
